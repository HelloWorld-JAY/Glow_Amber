    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/glowamber/multiImageUploader.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/glowamber/WEB-INF/views/AdminPage/singleImageUploader.jsp',	//샘플 URL입니다.
 	        sCallback : '/glowamber/resources/smarteditor/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
